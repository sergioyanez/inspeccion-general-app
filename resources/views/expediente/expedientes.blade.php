            ...
            <tbody class="table-border-bottom-0">
                @forelse($expedientes as $expediente)
                    <tr>
                        ...
                        <td class="filas">@if($expediente->estado_baja_id != null)Baja {{$expediente->estadoBaja->tipoBaja->descripcion}} @elseif(isset($expediente->detalleHabilitacion->fecha_vencimiento) && $expediente->detalleHabilitacion->fecha_vencimiento < now()) {{$expediente->detalleHabilitacion->tipoEstado->descripcion}} @else {{$expediente->detalleHabilitacion->tipoEstado->descripcion}} @endif</td>

...
<html lang="es">
    <head>
        ...
        <title>Crear Informe de dependencia</title>
    </head>
    <body>
        <div class="row">
            <div class="col-xl-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="mb-0">Creando un nuevo Informe de dependencia</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('informesDependencias-guardar') }}">
                            @csrf
                            <div class="mb-3">

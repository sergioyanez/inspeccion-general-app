                    ...
                    <form method="POST" action="{{ route('contribuyentes-actualizar') }}">
                            ...
                            <select name="tipo_dni_id" class="form-control" id="basic-default-nombreCompleto">
                                @foreach ($tipos as $tipo)
                                    <option value="{{ $tipo->id }}"
                                        @if ($tipo->id == $contribuyente->tipo_dni_id) selected @endif>{{ $tipo->descripcion }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <select name="estado_civil_id" class="form-control" id="basic-default-nombreCompleto">
                                @foreach ($estados as $estado)
                                    <option value="{{ $estado->id }}"
                                        @if ($estado->id == $contribuyente->estado_civil_id) selected @endif>>{{ $estado->descripcion }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <input required type="text" name="cuit" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->cuit }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input required type="text" name="ingresos_brutos" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->ingresos_brutos }}" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Nombre</label>
                            <input required type="text" name="nombre" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->nombre }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input required type="text" name="apellido" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->apellido }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input required type="text" name="dni" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->dni }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input required type="text" name="fecha_nacimiento" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->fecha_nacimiento }}" />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre_conyuge" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->nombre_conyuge }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="apellido_conyuge" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->apellido_conyuge }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="dni_conyuge" class="form-control"
                                id="basic-default-nombreCompleto" value="{{ $contribuyente->dni_conyuge }}" />
                        </div>

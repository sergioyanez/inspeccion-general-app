                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($informesDependencias as $informeDependencia)
                        <tr>
                            ...
                            <td><a href="{{ route('informesDependencias-mostrar', $informeDependencia->id) }}">Editar</a></td>
                            <td><a href="{{ route('informesDependencias-eliminar', $informeDependencia->id) }}">Eliminar</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
